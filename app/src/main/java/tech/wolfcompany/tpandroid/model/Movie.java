...
public class Movie {
    ...
    public Movie(long id, String name, String permalink, String start_date, String end_date, String country, String network, String status, String image_thumbnail_path) {
        this.id = id;
        this.name = name;
